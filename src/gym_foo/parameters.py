...
from gym.envs.gym_foo.job_distribution import *
...
class Parameters:
    def __init__(self, randstate):
        ...
        self.episode_max_length = 100 #0  # enforcing an artificial terminal # the max small time steps that 1 episode has # consistent with steps in gym _init_.py
        ...
        self.max_job_len =  1 #15          # maximum duration of new jobs
        self.res_slot = 10             # maximum number of available resource slots
        self.max_job_size =  1 #10         # maximum resource request of new work
        ...
        self.new_job_rate = 0.9  # 0.7        # lambda in new job arrival Poisson Process
