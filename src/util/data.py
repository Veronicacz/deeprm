...
class Data:
    ...
    PATH = '/home/veronica/Desktop/ddpg_deeprm/results/obj/'
    ...
    def save(self, path='', final_save=True):
        ...
        # final_file_name = '/home/veronica/Dropbox/Deep learning/resource/Deep-Reinforcement-Learning-in-Large-Discrete-Action-Spaces-master/results/obj/temp/' + self.get_file_name() + '.json'
