...
class Parameters:
    def __init__(self, randstate):
        ...
        self.backlog_size = 100 #300 #60         # backlog queue size
        ...
        self.dist = env.job_distribution.Dist(self.num_res,self.num_clu,self.max_job_size, self.max_job_len, randstate, self.trans_rate)
