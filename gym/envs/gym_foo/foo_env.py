...
#		self.plot_state()
	...
	def reset(self):
		...
		f=open("/home/veronica/Desktop/env/job_profile/0709/freezetime/normal/disslog.txt", "a")
#		tem_str1 = "nw_len," + self.nw_len_seqs + "\n" 
		...
		f1=open("/home/veronica/Desktop/env/job_profile/0709/freezetime/normal/nwlen.txt", "a")
#		tem_str1 = "nw_len," + self.nw_len_seqs + "\n" 
		for item in self.nw_len_seqs:
			f1.write("%s\n" % item)
		f1.close()
...
#		f1.close()
		...
		f2=open("/home/veronica/Desktop/env/job_profile/0709/freezetime/normal/nwsize.txt", "a")
